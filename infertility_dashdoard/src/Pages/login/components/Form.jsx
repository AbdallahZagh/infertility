  ...
  return (
    ...
    <div className='w-[45%] h-[85%] -mt-10 rounded-xl bg-white z-20 shadow flex justify-evenly items-center flex-col'>
        ...
        <div className='w-[85%] h-24 flex justify-center items-center flex-col relative'>
            <button className='w-[80%] h-12 bg-gradient-to-b from-[#E45E47] to-[#EB996E] text-white text-lg rounded-lg drop-shadow-md drop-shadow-[#E87F5D40] cursor-pointer hover:from-[#EB996E] hover:to-[#E45E47] transition-colors ease-in-out duration-300'>{t('login')}</button>
