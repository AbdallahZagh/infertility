...
const Header = () => {
  ...
  return (
    ...
    <div className={`w-[98%] h-72 mt-4 rounded-2xl bg-[#44AEC3] text-white flex justify-evenly items-center ${i18n.language == 'en' ?  'flex-row' : 'flex-row-reverse'} z-10 overflow-hidden`}>
      <img src={headerImg2} className='h-[75%]'/>
      <img src={header} className='h-[100%] w-[20%]'/>
      <div className='w-[60%] flex justify-center items-start flex-col gap-5'>
        <h2 className='text-3xl font-bold '>{t('header')}</h2>
        <p className=''>Lorem ipsum dolor sit amet consectetur. Cras consectetur eu integer vulputate feugiat rhoncus sed. Ornare egestas cras sollicitudin ante metus dignissim nisl posuere.</p>
      </div>
