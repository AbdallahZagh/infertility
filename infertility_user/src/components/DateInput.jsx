            ...
            >
                ...
                <div
                    className={`w-full h-60
                     ...
                     duration-500 rounded-lg shadow-md shadow-black bg-white z-10 overflow-hidden absolute ${i18n.language === 'en' ? '-right-0 -top-64' : '-left-0 -top-64'}`}
                >
                    {/* Header */}
                    <div className="flex justify-evenly items-center border-b border-[#18A2D6] text-[#18A2D6] p-1.5 rounded-t-lg">
                        ...
                        />
                        <div
                            className="text-lg w-[50%] text-center cursor-pointer"
                            onClick={(e) => {
                                e.stopPropagation();
                                        ...
                                        {week.map((day, dayIndex) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    onClick={(e) => {e.stopPropagation(); day && handleDateClick(day)}}
                                                >
                                                    {day || ''}
                                                </div>
                                            );
